...
class CreateProjectTool < MCP::Tool
  ...
  description "Creates a portfolio project. Body is Markdown. Status is one of active/completed/shelved (default active)."
  input_schema(
    properties: {
  ...
  def self.call(title:, body:, summary: nil, url: nil, status: nil, started_at: nil, ended_at: nil, tags: nil, server_context: nil)
...
class UpdateProjectTool < MCP::Tool
  ...
  description "Updates an existing project by id or slug. Only provided fields are changed."
  input_schema(
    properties: {
  ...
  def self.call(id:, title: nil, body: nil, summary: nil, url: nil, status: nil, started_at: nil, ended_at: nil, tags: nil, server_context: nil)
