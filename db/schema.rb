...
ActiveRecord::Schema[8.1].define(version: 2026_09_22_000003) do
  ...
  create_table "generation_tasks", force: :cascade do |t|
    ...
    t.text "focus"
    t.integer "generation_kind", null: false
    t.integer "job_application_id", null: false
    t.integer "kind", null: false
    t.string "model"
    t.integer "parent_draft_id"
    t.text "selection_feedback"
    t.text "selection_json"
    t.datetime "started_at"
    t.boolean "succeeded", default: false, null: false
    t.datetime "updated_at", null: false
    t.index ["application_draft_id"], name: "index_generation_tasks_on_application_draft_id"
    t.index ["job_application_id"], name: "index_generation_tasks_on_job_application_id"
    t.index ["parent_draft_id"], name: "index_generation_tasks_on_parent_draft_id"
    t.index ["started_at"], name: "index_generation_tasks_on_started_at"
    t.index ["succeeded"], name: "index_generation_tasks_on_succeeded"
  end
  ...
  add_foreign_key "generation_tasks", "application_drafts"
  add_foreign_key "generation_tasks", "application_drafts", column: "parent_draft_id"
  add_foreign_key "generation_tasks", "job_applications"
